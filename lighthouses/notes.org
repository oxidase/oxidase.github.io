...
echo '[out:json];(node(330119702);>;);out;(node(2651078254);>;);out;(node(538969144);>;);out;(node(1460052772);>;);out;(node(32564162);>;);out;(node(269331345);>;);out;' | query-overpass --flat-properties > lighthouses_kiel.geojson
